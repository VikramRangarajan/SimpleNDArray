...
class _BmmModuleClass(PythonModule):
    if TYPE_CHECKING:
        ...
        def bmm_double(self, a_ptr: int, a_off: int, a_stride_b: int, a_stride_m: int, a_stride_k: int, b_ptr: int, b_off: int, b_stride_b: int, b_stride_k: int, b_stride_n: int, c_ptr: int, c_off: int, c_stride_b: int, c_stride_m: int, c_stride_n: int, B: int, M: int, K: int, N: int, alpha: float, beta: float) -> None: ...
        pass
